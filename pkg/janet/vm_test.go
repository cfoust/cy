...
func TestVM(t *testing.T) {
	...
	t.Run("janet marshaling with Bytes() and FromBytes()", func(t *testing.T) {
		...
		t.Run("integer", func(t *testing.T) {
			...
			require.NoError(t, err)
			require.NotEmpty(t, bytes, "marshaled bytes should not be empty")
			...
			require.NoError(t, err)
			require.Equal(t, original, result, "unmarshaled value should match original")
		})
