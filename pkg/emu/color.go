...
var (
	...
	Magenta      = ANSIColor(5)
	Cyan         = ANSIColor(6)
	LightGrey    = ANSIColor(7)
	DarkGrey     = ANSIColor(8)
	LightRed     = ANSIColor(9)
	LightGreen   = ANSIColor(10)
	LightYellow  = ANSIColor(11)
	LightBlue    = ANSIColor(12)
	LightMagenta = ANSIColor(13)
	LightCyan    = ANSIColor(14)
	White        = ANSIColor(15)
)
