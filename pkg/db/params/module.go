...
// findStateDir returns the appropriate XDG_STATE_HOME directory
...
// OpenDB opens and initializes the parameters database
func OpenDB() (*DB, error) {
	stateDir := findStateDir()
	return OpenDBAt(filepath.Join(stateDir, "params.db"))
}

// OpenDBAt opens and initializes the parameters database at a specific path
